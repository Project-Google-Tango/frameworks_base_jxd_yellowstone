...
public class AudioService extends IAudioService.Stub {
    ...
    private static final String SOUND_EFFECTS_PATH_LBH = "/lbh/media/audio/ui/";
   ...
   /** @hide Maximum volume index values for audio streams */
    ...
    public class VolumeStreamState {
        ...
        public synchronized boolean setIndex(int index, int device) {
            ...
            index = NvEdpManager.checkDeviceLimit(NvEdpManager.EDP_CLIENT_AUDIO_VOLUME, index, mIndexMax);
                ...
                for (int effect = 0; effect < AudioManager.NUM_SOUND_EFFECTS; effect++) {
                    ...
                    if (poolId[SOUND_EFFECT_FILES_MAP[effect][0]] == -1) {
                        ...
                        if (!lbh_id.equals("") && !lbh_id.equals(LBH_ID_PROPERTY_DEFAULT)) {
                            String filePath_lbh = SOUND_EFFECTS_PATH_LBH
                                    + SOUND_EFFECT_FILES.get(SOUND_EFFECT_FILES_MAP[effect][0]);
                            int sampleId_lbh = mSoundPool.load(filePath_lbh, 0);
                            if (sampleId_lbh <= 0) {
                                Log.w(TAG, "Soundpool could not load file from LBH: "+filePath_lbh);
                                // Try to load sample from system, if it's failed from LBH
                                ...
                                SOUND_EFFECT_FILES_MAP[effect][1] = sampleId_lbh;
                                poolId[SOUND_EFFECT_FILES_MAP[effect][0]] = sampleId_lbh;
                                numSamples++;
                            }
                        } else {
                            String filePath = Environment.getRootDirectory()
    ...
    int mBecomingNoisyIntentDevices =
            ...
            AudioSystem.DEVICE_OUT_ALL_USB | AudioSystem.DEVICE_OUT_REMOTE_SUBMIX;
