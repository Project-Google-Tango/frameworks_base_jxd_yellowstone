...
public class Paint {
    ...
    private float       mNvDownScaleFactor;
   ...
   /**
    ...
    private void setClassVariablesFrom(Paint paint) {
        ...
        mNvDownScaleFactor = paint.mNvDownScaleFactor;
    ...
    /** @hide */
    public void setNvDownScaleFactor(float nvDownScaleFactor) {
        mNvDownScaleFactor = nvDownScaleFactor;
    }
    ...
    public float measureText(char[] text, int index, int count) {
        ...
        if (!mHasCompatScaling && mNvDownScaleFactor == 1.0f) {
            return (float) Math.ceil(native_measureText(text, index, count, mBidiFlags));
        }

        final float oldSize = getTextSize();
        setTextSize(oldSize*mCompatScaling / mNvDownScaleFactor);
        float w = native_measureText(text, index, count, mBidiFlags);
        setTextSize(oldSize);
        return (float) Math.ceil(w*mInvCompatScaling * mNvDownScaleFactor);
    }
    ...
    public int breakText(char[] text, int index, int count,
        ...
        final float oldSize = getTextSize();
        setTextSize(oldSize*mCompatScaling / mNvDownScaleFactor);
        int res = native_breakText(text, index, count, maxWidth*mCompatScaling / mNvDownScaleFactor, mBidiFlags,
                measuredWidth);
        setTextSize(oldSize);
        if (measuredWidth != null) measuredWidth[0] *= mInvCompatScaling * mNvDownScaleFactor;
        return res;
    }
    ...
    public int breakText(String text, boolean measureForwards,
        ...
        final float oldSize = getTextSize();
        setTextSize(oldSize*mCompatScaling / mNvDownScaleFactor);
        int res = native_breakText(text, measureForwards, maxWidth*mCompatScaling / mNvDownScaleFactor, mBidiFlags,
                measuredWidth);
        setTextSize(oldSize);
        if (measuredWidth != null) measuredWidth[0] *= mInvCompatScaling * mNvDownScaleFactor;
        return res;
    ...
    public int getTextWidths(char[] text, int index, int count,
        ...
        setTextSize(oldSize);
        for (int i=0; i<res; i++) {
            widths[i] *= mInvCompatScaling * mNvDownScaleFactor;
        }
        return res;
    }
    ...
    public float getTextRunAdvances(char[] chars, int index, int count,
        ...
        if (advances != null) {
            for (int i = advancesIndex, e = i + count; i < e; i++) {
                advances[i] *= mInvCompatScaling * mNvDownScaleFactor;
            }
        }
        return res * mInvCompatScaling * mNvDownScaleFactor; // assume errors are not significant
    }
    ...
    public float getTextRunAdvances(String text, int start, int end, int contextStart,
        ...
        return totalAdvance * mInvCompatScaling * mNvDownScaleFactor; // assume errors are insignificant
    }
