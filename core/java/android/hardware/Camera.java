...
public class Camera {
    ...
    private NvEdpManager.NvEdpCamera mEdpClient;
    ...
    Camera(int cameraId) {
        ...
        mEdpClient = NvEdpManager.NvEdpCamera.getInstance(this, packageName);
    }
    ...
    public void setParameters(Parameters params) {
        ...
        if (mEdpClient != null) mEdpClient.edpSetParameters(params);
    ...
    public Parameters getParameters() {
        ...
        p.unflatten(s);
        if (mEdpClient != null) mEdpClient.edpGetParameters(p);
        return p;
    }
