...
public class SystemSensorManager extends SensorManager {
    ...
    static final class SensorEventQueue extends BaseEventQueue {
        ...
        private final SystemSensorManager mSystemSensorManager;

        public SensorEventQueue(SensorEventListener listener, Looper looper,
                SystemSensorManager manager) {
            super(looper, manager);
            mListener = listener;
            mSystemSensorManager = manager;
        }
        ...
        protected void dispatchSensorEvent(int handle, float[] values, int inAccuracy,
            ...
            MapperEventPool mapperEventPool = mSystemSensorManager.getMapperEventPool();
            if (mapperEventPool != null && mapperEventPool.isMappingEnabled()) {
                mapperEventPool.mapEventValues(t.values, t.sensor.getType());
            }
    ...
    public MapperEventPool getMapperEventPool() {
        if (mContext != null && mContext.getApplicationContext() != null) {
            return mContext.getApplicationContext().getMapperEventPool();
        }
        return null;
     }
