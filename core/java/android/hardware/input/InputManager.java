...
public final class InputManager {
    ...
    /**
     * Set stylus finger only mode of app.
     * Invokes {@link com.android.server.input.InputManagerService#setAppStylusFingerOnlyMode}
     * @hide
     */
    public void setAppStylusFingerOnlyMode(boolean fingerOnly) {
        try {
            mIm.setAppStylusFingerOnlyMode(fingerOnly);
        } catch (RemoteException ex) {
            Log.w(TAG, "Could not set app stylus fingerOnly mode.", ex);
        }
    }

    /**
     * Get package name of app to be in stylus whitelist virtually.
     * Invokes {@link com.android.server.input.InputManagerService#getStylusEnablePackage}
     * @hide
     */
    public String getStylusEnablePackage() {
        try {
            return mIm.getStylusEnablePackage();
        } catch (RemoteException ex) {
            Log.w(TAG, "Could not get package name to enable stylus support.", ex);
        }
        return null;
    }
