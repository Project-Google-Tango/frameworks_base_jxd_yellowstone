...
public final class CaptureResult extends CameraMetadata {
    ...
    public static final Key<Float> NVIDIA_DNG_WHITEBALANCE =
            new Key<Float>("com.nvidia.parameters.dng_whitebalance", float.class);

    public static final Key<float[]> NVIDIA_DNG_WBNEUTRAL =
            new Key<float[]>("com.nvidia.parameters.dng_wbneutral", float[].class);

    public static final Key<Float> NVIDIA_DNG_GAIN =
            new Key<Float>("com.nvidia.parameters.dng_gain", float.class);

    public static final Key<float[]> NVIDIA_DNG_RAWTORGB3000K =
            new Key<float[]>("com.nvidia.parameters.dng_rawtorgb3000k", float[].class);

    public static final Key<float[]> NVIDIA_DNG_RAWTORGB6500K =
            new Key<float[]>("com.nvidia.parameters.dng_rawtorgb6500k", float[].class);

    public static final Key<Integer> NVIDIA_AWB_CCT =
            new Key<Integer>("com.nvidia.parameters.awb_cct", int.class);
