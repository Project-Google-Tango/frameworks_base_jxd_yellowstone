...
public class VolumePreference extends SeekBarDialogPreference implements
    ...
    public class SeekBarVolumizer implements OnSeekBarChangeListener, Handler.Callback {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress,
            ...
            int edp_value = NvEdpManager.checkDeviceLimit(NvEdpManager.EDP_CLIENT_AUDIO_VOLUME, progress, mAudioManager.getStreamMaxVolume(mStreamType));
            postSetVolume(edp_value);
            if(progress != edp_value)
                mSeekBar.setProgress(edp_value);
        }
