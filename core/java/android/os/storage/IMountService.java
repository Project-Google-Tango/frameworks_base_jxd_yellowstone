...
public interface IMountService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMountService {
        private static class Proxy implements IMountService {
            ...
            /**
             * Gets an Array of currently managed secure container IDs
             */
            public String[] getCurrentSecureContainerList() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                String[] _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_getCurrentSecureContainerList, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.createStringArray();
                } finally {
                    _reply.recycle();
            ...
            /*
             * Check if a directory has any obb files. It checks the the existence of
             * the directory but with checkFile = true .obb files are checked in the
             * directory.
             */
            public long checkObb(String pkgObbDir, boolean checkFile) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                long _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(pkgObbDir);
                    _data.writeInt((checkFile ? 1 : 0));
                    mRemote.transact(Stub.TRANSACTION_checkObb, _data, _reply, 0);
                    _reply.readException();
            ...
            /*
             * Move obb files in the source directory to the destination directory.
             * It's for "moving app to sd card" feature. One of two directory should be
             * in secondary sdcard.
             */
            public int moveObb(String srcDir, String destDir, long sizeBytes) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(srcDir);
                    _data.writeString(destDir);
                    _data.writeLong(sizeBytes);
                    mRemote.transact(Stub.TRANSACTION_moveObb, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readInt();
                } finally {
                    _reply.recycle();
            ...
            /*
             * Do bind mount source directory (in secondary  sdcard) to destination directory.
             */
            public int mountObbMove(String srcDir, String destDir) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _result;
                try {
                    ...
                    _data.writeString(srcDir);
                    _data.writeString(destDir);
                    mRemote.transact(Stub.TRANSACTION_mountObbMove, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readInt();
                } finally {
                    _reply.recycle();
            ...
            /*
             * Do bind unmount for a mount point
             */
            public int unmountObbMove(String mountPoint, boolean force) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _result;
                try {
                    ...
                    _data.writeString(mountPoint);
                    _data.writeInt((force ? 1 : 0));
                    mRemote.transact(Stub.TRANSACTION_unmountObbMove, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readInt();
                } finally {
                    _reply.recycle();
            ...
            /*
             * Recover obb move failures.
             */
            public int recoverObb(String srcDir, String destDir, long sizeBytes) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _result;
                try {
                    ...
                    _data.writeString(destDir);
                    _data.writeLong(sizeBytes);
                    mRemote.transact(Stub.TRANSACTION_recoverObb, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readInt();
                } finally {
                    _reply.recycle();
        ...
        static final int TRANSACTION_getCurrentSecureContainerList = IBinder.FIRST_CALL_TRANSACTION + 35;

        static final int TRANSACTION_checkObb = IBinder.FIRST_CALL_TRANSACTION + 36;

        static final int TRANSACTION_moveObb = IBinder.FIRST_CALL_TRANSACTION + 37;

        static final int TRANSACTION_mountObbMove = IBinder.FIRST_CALL_TRANSACTION + 38;

        static final int TRANSACTION_unmountObbMove = IBinder.FIRST_CALL_TRANSACTION + 39;

        static final int TRANSACTION_recoverObb = IBinder.FIRST_CALL_TRANSACTION + 40;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply,
            ...
            switch (code) {
                ...
                case TRANSACTION_getCurrentSecureContainerList: {
                    data.enforceInterface(DESCRIPTOR);
                    String[] ids = getCurrentSecureContainerList();
                    reply.writeNoException();
                    reply.writeStringArray(ids);
                    return true;
                }
                ...
                case TRANSACTION_checkObb: {
                    data.enforceInterface(DESCRIPTOR);
                    String pkgObbDir;
                    pkgObbDir = data.readString();
                    boolean checkFile;
                    checkFile = 0 != data.readInt();
                    long resultCode = checkObb(pkgObbDir, checkFile);
                    reply.writeNoException();
                    reply.writeLong(resultCode);
                    return true;
                }
                case TRANSACTION_moveObb: {
                    data.enforceInterface(DESCRIPTOR);
                    String srcDir;
                    srcDir = data.readString();
                    String destDir;
                    destDir = data.readString();
                    long sizeBytes;
                    sizeBytes = data.readLong();
                    int resultCode = moveObb(srcDir, destDir, sizeBytes);
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                }
                case TRANSACTION_mountObbMove: {
                    data.enforceInterface(DESCRIPTOR);
                    String srcDir;
                    srcDir = data.readString();
                    String destDir;
                    destDir = data.readString();
                    int resultCode = mountObbMove(srcDir, destDir);
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                }
                case TRANSACTION_unmountObbMove: {
                    data.enforceInterface(DESCRIPTOR);
                    String mountPoint;
                    mountPoint = data.readString();
                    boolean force;
                    force = 0 != data.readInt();
                    int resultCode = unmountObbMove(mountPoint, force);
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                }
                case TRANSACTION_recoverObb: {
                    data.enforceInterface(DESCRIPTOR);
                    String srcDir;
                    srcDir = data.readString();
                    String destDir;
                    ...
                    long sizeBytes;
                    sizeBytes = data.readLong();
                    int resultCode = recoverObb(srcDir, destDir, sizeBytes);
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                }
