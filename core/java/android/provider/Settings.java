...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * Nvidia Shield LED brightness between 0 and 255.
         * @hide
         */
        public static final String NV_LED_BRIGHTNESS = "nv_led_brightness";

        /**
         * Nvidia Shield control to enable automatic brightness mode for LED.
         * @hide
         */
        public static final String NV_LED_BRIGHTNESS_MODE = "nv_led_brightness_mode";

        /**
         * Nvidia Shield control for if the LED should pulse.
         * @hide
         */
        public static final String NV_LED_BREATHE = "nv_led_breathe";

        /**
         * NV_LED_BRIGHTNESS_MODE value for manual mode.
         * @hide
         */
        public static final int NV_LED_BRIGHTNESS_MODE_MANUAL = 0;

        /**
         * NV_LED_BRIGHTNESS_MODE value for automatic mode.
         * @hide
         */
        public static final int NV_LED_BRIGHTNESS_MODE_AUTOMATIC = 1;
        ...
        /**
         * Control whether the RS Mouse is enabled or disabled for the
         * user.
         *
         * If 0, then RS Mouse is disabled. If 1, then RS Mouse is
         * available.
         *
         * @hide
         */
        public static final String RS_MOUSE = "controller_rsmouse";

        /**
         * Control whether the Mouse reports as a mouse or touch event
         *
         * If 0, then Mouse is a mouse. If 1, then Mouse reports touch
         * events
         *
         * @hide
         */
        ...
        /**
         * Show joystick location on screen?
         * 0 = no
         * 1 = yes
         * @hide
         */
        public static final String JOYSTICK_LOCATION = "joystick_location";
        ...
        /**
         * Show stylus position on screen?
         * 0 = no
         * 1 = yes
         * @hide
         */
        public static final String SHOW_STYLUS = "show_stylus";

        /**
         * Show eraser positions on screen?
         * 0 = no
         * 1 = yes
         * @hide
         */
        public static final String SHOW_ERASER = "show_eraser";

        /**
         * PEN_TO_TOUCH_DELAY_MS
         * 0 = disable
         * >0 = length of delay
         * @hide
         */
        public static final String PEN_TO_TOUCH_DELAY_MS = "pen_to_touch_delay_ms";

        /**
         * Override stylus left-handed or right-handed?
         * 0 = no
         * 1 = yes
         * @hide
         */
        public static final String STYLUS_LEFT_HANDED = "stylus_left_handed";

        /**
         * Package name for action when stylus removed. The value is string.
         * @hide
         */
        public static final String ACTION_STYLUS_REMOVE_PACKAGE = "action_stylus_remove_package";

        /**
         * Activity name for action when stylus removed. The value is string.
         * @hide
         */
        public static final String ACTION_STYLUS_REMOVE_ACTIVITY = "action_stylus_remove_activity";

        /**
         * List of apps to be shown in the DirectStylus Launcher by default. The value is string.
         * Apps are separated by comma, package/activity name of the app are separated by slash.
         * e.g. "package1/activity1,package2/activity2,..."
         * @hide
         */
        public static final String STYLUS_LAUNCHER_DEFAULT_APPS = "stylus_launcher_default_apps";

        /**
         * Override stylus whitelist and enable stylus always?
         * 0 = no
         * 1 = yes
         * @hide
         */
        public static final String ENABLE_STYLUS = "enable_stylus";
         ...
         * @hide
         */
        public static final String PROMPT_TV_MODE = "prompt_tv_mode";
