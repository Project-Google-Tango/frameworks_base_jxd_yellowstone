...
public class Surface implements Parcelable {
    ...
    /** @hide */
    void setNvDownScaleFactor(float downScaleFactor) {
        mNvDownScaleFactor = downScaleFactor;
    }
    ...
    private final class CompatibleCanvas extends Canvas {
        ...
        public void setMatrix(Matrix matrix) {
            if ((mNvDownScaleFactor == 1.0f && mCompatibleMatrix == null) ||
                mOrigMatrix == null || mOrigMatrix.equals(matrix)) {
                ...
                Matrix m;
                if (mCompatibleMatrix != null) {
                    m = new Matrix(mCompatibleMatrix);
                } else {
                    m = new Matrix();
                    m.setScale(1.0f / mNvDownScaleFactor, 1.0f / mNvDownScaleFactor);
                }
                m.preConcat(matrix);
                super.setMatrix(m);
            }
