...
public interface WindowManagerPolicy {
    ...
    /**
     * Custom broadcast intent for the stylus pen state change.
     */
    public final static String ACTION_PEN_CHANGED = "com.nvidia.intent.action.PEN_CHANGED";

    /**
     * Extra in {@link #ACTION_PEN_CHANGED} indicating the state:
     * inserted if pen is inserted to device, removed if removed.
     */
    public final static String EXTRA_PEN_STATE = "state";
    public final static String PEN_STATE_INSERTED = "inserted";
    public final static String PEN_STATE_REMOVED = "removed";

    /**
     * Custom broadcast intent for the system level touch lock state change.
     */
    public final static String ACTION_LOCK_TOUCH = "com.nvidia.intent.action.LOCK_TOUCH";
    public final static String ACTION_TOUCH_LOCKED = "com.nvidia.intent.action.TOUCH_LOCKED";

    /**
     * Extra in {@link #ACTION_LOCK_TOUCH} indicating the state:
     * true if touch is locked, false if unlocked.
     */
    public final static String EXTRA_TOUCH_LOCK = "isLocked";

    /**
     * Custom broadcast intent for overriding app whitelist to support stylus
     */
    public final static String ACTION_ENABLE_STYLUS = "com.nvidia.intent.action.ENABLE_STYLUS";

    /**
     * Extra in {@link #ACTION_ENABLE_STYLUS} indicating the package name:
     * package name string to add the package to stylus app whitelist virtually,
     * null or empty string to remove current package from the virtual whitelist.
     */
    public final static String EXTRA_ENABLE_STYLUS_PACKAGE = "package";
    ...
    public interface WindowManagerFuncs {
        ...
        /** Register a system listener for joystick events */
        void registerJoystickEventListener(JoystickEventListener listener);

        /** Unregister a system listener for josytick events */
        void unregisterJoystickEventListener(JoystickEventListener listener);
    }
    ...
    public interface JoystickEventListener {
        ...
        public void onGamepadEvent(KeyEvent keyevet);
    }
    ...
    /**
     * Tell the policy that the stylus pen switch has changed state.
     * @param penRemoved True if the stylus pen is now removed.
     */
