...
import com.nvidia.ControllerMapper.MapperClient;
...
public final class ViewRootImpl implements ViewParent,
    ...
    /**
     * Set this system property to true to forcibly disable the use of
     * EGL_EXT_buffer_age.
     *
     * @hide
     */
    private static final String PROPERTY_DISABLE_BUFFER_AGE = "debug.hwui.disable_buffer_age";
    ...
    private MapperClient mMapperClient;
    ...
    final float mNvDownScaleFactor;
    ...
    public ViewRootImpl(Context context, Display display) {
        ...
        mNvDownScaleFactor = context.getNvDownScaleFactor(display);
    }
    ...
    public void setView(View view, WindowManager.LayoutParams attrs, View panelParentView) {
        synchronized (this) {
            if (mView == null) {
                ...
                } else if (mNvDownScaleFactor != 1.0f) {
                    mSurface.setNvDownScaleFactor(mNvDownScaleFactor);
                    restore = true;
                    attrs.backup();
                    attrs.scale(1.0f / mNvDownScaleFactor);
                }
                ...
                mAttachInfo.mScalingRequired = mTranslator != null || mNvDownScaleFactor != 1.0f;
                mAttachInfo.mApplicationScale =
                        mTranslator == null ? 1.0f / mNvDownScaleFactor : mTranslator.applicationScale;
                ...
                if (mTranslator != null) {
                    ...
                    mAttachInfo.mContentInsets.scale(mNvDownScaleFactor);
                }
                ...
                if (mInputChannel != null) {
                    ...
                    try {
                        ...
                        mInputEventReceiver.mConsumeBatchesImmediately =
    ...
    private void enableHardwareAcceleration(WindowManager.LayoutParams attrs) {
        ...
        if (mTranslator != null || mNvDownScaleFactor != 1.0f) return;
        ...
        if (hardwareAccelerated) {
            ...
            if (!HardwareRenderer.sRendererDisabled || (HardwareRenderer.sSystemRendererDisabled
                ...
                NvAppProfiles appProfiles = new NvAppProfiles(mView.getContext());
                // TODO: Add a global off switch once NvCPL supports global namespaces.
                final boolean useFramebufferAge =
                    !SystemProperties.getBoolean(PROPERTY_DISABLE_BUFFER_AGE, false)
                    && appProfiles.getApplicationProfile(mView.getContext().getPackageName(),
                                                         NvAppProfileSettingId.DISABLE_BUFFER_AGE) != 1;
                final boolean translucent = attrs.format != PixelFormat.OPAQUE;
                mAttachInfo.mHardwareRenderer = HardwareRenderer.createGlRenderer(2, translucent, useFramebufferAge);
                if (mAttachInfo.mHardwareRenderer != null) {
                    ...
                    try {
                        Activity activity = (Activity)mView.mContext;
                        ActivityInfo ai = activity.getPackageManager().getActivityInfo(
                            activity.getComponentName(), PackageManager.GET_META_DATA);
                        mAttachInfo.mHardwareRenderer.setUsePostSubBuffer(
                            ai.metaData.getBoolean("com.nvidia.usePostSubBuffer"));
                    } catch(Exception e) {
                    }
                }
    ...
    /*
     * activated : app is changed visible
     * inactivated : app is changed invisible or window is removed
     */
    void activateWindow(boolean active) {
        Message msg = mHandler.obtainMessage(MSG_WINDOW_ACTIVATED);
        msg.arg1 = active ? 1 : 0;
        mHandler.sendMessage(msg);
    }

    /*
     * create MapperClient when window is activeted, and,
     * kill this MapperClietn when window is inactivated.
     */
    void handleWindowActivated(boolean active) {
        if (active) {
            if (mMapperClient == null && mView != null
                && MapperClient.isBuildEnabled(mView.getContext()))
                mMapperClient = new MapperClient(mView.getContext(), this);
        } else {
            if (mMapperClient != null) {
                mMapperClient.die();
                mMapperClient = null;
            }
        }
    ...
    public ViewParent invalidateChildInParent(int[] location, Rect dirty) {
        ...
        if (mCurScrollY != 0 || mTranslator != null || mNvDownScaleFactor != 1.0f) {
            mTempRect.set(dirty);
            dirty = mTempRect;
            if (mCurScrollY != 0) {
            ...
            if (mTranslator != null) {
                ...
                dirty.scale(1.0f / mNvDownScaleFactor);
            }
        ...
        if (mFirst || windowShouldResize || insetsChanged ||
                    ...
                    if (mWidth > 0 && mHeight > 0 && lp != null &&
                        ...
                        try {
                            ...
                            if (mTranslator != null) {
                                ...
                                layerCanvas.scale(1.0f / mNvDownScaleFactor, 1.0f / mNvDownScaleFactor);
                            }
            ...
            if (windowMoved) {
                if (mTranslator != null) {
                    ...
                    frame.scale(mNvDownScaleFactor);
                }
                attachInfo.mWindowLeft = frame.left;
                attachInfo.mWindowTop = frame.top;
            }
        ...
        if (didLayout) {
            ...
            if ((host.mPrivateFlags & View.PFLAG_REQUEST_TRANSPARENT_REGIONS) != 0) {
                ...
                if (mTranslator != null) {
                    ...
                    mTransparentRegion.scale(1.0f / mNvDownScaleFactor);
                }
        ...
        if (computesInternalInsets) {
            ...
            if (insetsPending || !mLastGivenInsets.equals(insets)) {
                ...
                if (mTranslator != null) {
                    ...
                    contentInsets.set(insets.contentInsets);
                    contentInsets.scale(1.0f / mNvDownScaleFactor);
                    visibleInsets = new Rect();
                    visibleInsets.set(insets.visibleInsets);
                    visibleInsets.scale(1.0f / mNvDownScaleFactor);
                    touchableRegion = new Region();
                    touchableRegion.set(insets.touchableRegion);
                    touchableRegion.scale(1.0f / mNvDownScaleFactor);
                } else {
        ...
        try {
            ...
            try {
                ...
                if (mTranslator != null) {
                    ...
                    canvas.scale(1.0f / mNvDownScaleFactor, 1.0f / mNvDownScaleFactor);
                }
    ...
    private final static int MSG_WINDOW_ACTIVATED = 26;
    ...
    final class ViewRootHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_WINDOW_ACTIVATED: {
                handleWindowActivated(msg.arg1 != 0);
                break;
            }
            }
        }
    ...
    final class EarlyPostImeInputStage extends InputStage {
        ...
        private int processPointerEvent(QueuedInputEvent q) {
            ...
            if (mTranslator != null) {
                ...
                event.scale(mNvDownScaleFactor);
            }
    ...
    final class SyntheticJoystickHandler extends Handler {
        ...
        public boolean cancel(MotionEvent event) {
            ...
            if (what == DragEvent.ACTION_DRAG_EXITED) {
                ...
                if ((what == DragEvent.ACTION_DRAG_LOCATION) || (what == DragEvent.ACTION_DROP)) {
                    ...
                    if (mTranslator != null) {
                        ...
                        mDragPoint.x *= mNvDownScaleFactor;
                        mDragPoint.y *= mNvDownScaleFactor;
                    }
    ...
    private int relayoutWindow(WindowManager.LayoutParams params, int viewVisibility,
        ...
        } else if (params != null && mNvDownScaleFactor != 1.0f) {
            restore = true;
            params.backup();
            params.scale(1.0f / mNvDownScaleFactor);
        }
        if (params != null) {
        ...
        if (mTranslator != null) {
            ...
            mWinFrame.scale(mNvDownScaleFactor);
            mPendingOverscanInsets.scale(mNvDownScaleFactor);
            mPendingContentInsets.scale(mNvDownScaleFactor);
            mPendingVisibleInsets.scale(mNvDownScaleFactor);
        }
    ...
    public void dispatchResized(Rect frame, Rect overscanInsets, Rect contentInsets,
        ...
        if (mTranslator != null) {
            ...
            frame.scale(mNvDownScaleFactor);
            overscanInsets.scale(mNvDownScaleFactor);
            contentInsets.scale(mNvDownScaleFactor);
            visibleInsets.scale(mNvDownScaleFactor);
        }
    ...
    public void dispatchMoved(int newX, int newY) {
        ...
        if (mTranslator != null) {
            ...
            newX = (int)(newX * mNvDownScaleFactor + 0.5f);
            newY = (int)(newY * mNvDownScaleFactor + 0.5f);
        }
    ...
    public void injectEnqueueInputEvent(InputEvent event) {
        enqueueInputEvent(event);
    }

    public float getAppScale() {
        return mAttachInfo.mApplicationScale;
    }
    ...
    final class WindowInputEventReceiver extends InputEventReceiver {
        ...
        public boolean mConsumeBatchesImmediately = false;
    }
    ...
    static class W extends IWindow.Stub {
        ...
        public void activateWindow(boolean active) {
            final ViewRootImpl viewAncestor = mViewAncestor.get();
            if (viewAncestor != null) {
                viewAncestor.activateWindow(active);
            }
        }
    }
