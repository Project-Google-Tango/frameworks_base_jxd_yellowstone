...
public class SurfaceControl {
    ...
    /**
     * Surface creation flag: Window represents a cursor glyph and should use
     * an asynchronous cursor mechanism if available
     * @hide
     */
    public static final int NV_CURSOR_WINDOW = 0x00002000;
