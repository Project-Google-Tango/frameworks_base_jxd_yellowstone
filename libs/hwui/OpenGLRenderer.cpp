...
void OpenGLRenderer::resume() {
    ...
    mCaches.enableScissor(Caches::kUpdateMode_Force);
    mCaches.resetScissor();
    dirtyClip();
...
status_t OpenGLRenderer::callDrawGLFunction(Functor* functor, Rect& dirty) {
    ...
    DrawGlInfoExt info;
    info.viewportWidth = getSnapshot()->viewport.getWidth();
    info.viewportHeight = getSnapshot()->viewport.getHeight();
    info.clipLeft = clip.left;
    info.clipTop = clip.top;
    info.clipRight = clip.right;
    info.clipBottom = clip.bottom;
    info.stencilEnabled = mCaches.stencil.isEnabled();
    info.stencilRefIfEnabled = Stencil::kStencilRef;
    info.stencilMaskIfEnabled = Stencil::kStencilMask;
    info.blendEnabled = mCaches.blend;
    info.blendSrcMode = mCaches.lastSrcMode;
    info.blendDstMode = mCaches.lastDstMode;
    info.framebufferBinding = getSnapshot()->fbo;
