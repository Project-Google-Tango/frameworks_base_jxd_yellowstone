...
#if !DEBUG_STENCIL
    /**
     * Indicate the stencil function used when test or write are enabled.
     */
    static const int kStencilRef = 0x1;
    static const int kStencilMask = 0x1;
#else
    static const int kStencilRef = 0xff;
    static const int kStencilMask = 0xff;
#endif
