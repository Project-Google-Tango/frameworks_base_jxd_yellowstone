...
void InputDispatcher::doDispatchCycleFinishedLockedInterruptible(
    ...
    if (dispatchEntry) {
        ...
        if (dispatchEntry->eventEntry->type == EventEntry::TYPE_KEY) {
            ...
            if (dispatchEntry->hasForegroundTarget()) {
                InputFilter::RSMouse::notifyKeyState(keyEntry->deviceId, keyEntry->keyCode, handled);
            }
            ...
            if (dispatchEntry->hasForegroundTarget()) {
                InputFilter::RSMouse::notifyMotionState(motionEntry->deviceId, motionEntry->pointerCoords, handled);
            }
        } else {
            restartEvent = false;
        }
