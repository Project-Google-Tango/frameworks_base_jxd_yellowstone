...
public:
    ...
    enum Presentation {
        ...
        PRESENTATION_SPOT,
        // Show a glyph on the location of the stylus
        PRESENTATION_STYLUS,
        // Show a glyph on the location of the eraser
        PRESENTATION_ERASER,
        // Show a glyph on the location of the eraser and stylus
        PRESENTATION_STYLUS_AND_ERASER,
    };
...
struct PointerResources {
    ...
    SpriteIcon spotEraser;
    SpriteIcon spotStylus;
};
