...
final class ActivityStack {
    ...
    public NvAppProfileService mAppProfileService;
    ...
    ActivityStack(ActivityManagerService service, Context context, Looper looper, int stackId) {
        ...
        mAppProfileService = new NvAppProfileService(context);
    }
    ...
    private void completeResumeLocked(ActivityRecord next) {
        ...
        setAppProfileAsync(mAppProfileService, next.packageName);
    }

    private void setAppProfileAsync(final NvAppProfileService service, final String name) {
        AsyncTask.execute(new Runnable() {
            @Override
            public void run() {
                service.setAppProfile(name);
            }
       });
    }
