...
final class InputMonitor implements InputManagerService.WindowManagerCallbacks {
    ...
    private boolean mIsStylusSupported;

    public InputMonitor(WindowManagerService service) {
        mService = service;
        mIsStylusSupported = SystemProperties.getBoolean("ro.feature.stylus", false);
    }
    ...
    /* Notifies that the stylus switch changed state. */
    public void notifyStylusSwitchChanged(boolean penRemoved) {
        if (mIsStylusSupported) {
            mService.mPolicy.notifyStylusSwitchChanged(penRemoved);
        }
    }
