...
public class WifiP2pManager {
    ...
    /**
     * Broadcast this intent when a p2p device gets disconnected.
     * For multiple p2p devices WIFI_P2P_PERSISTENT_GROUPS_CHANGED_ACTION cannot be used alone
     * @hide
     **/
    public static final String WIFI_P2P_STA_DISCONNECT =
        "android.net.wifi.p2p.WIFI_P2P_STA_DISCONNECT";
    ...
    /** @hide */
    public static final int CMD_SET_MIRACAST_MODE                   = BASE + 74;
    /** @hide */
    public static final int MIRACAST_MODE_SUCCESS                   = BASE + 75;
    /** @hide */
    public static final int MIRACAST_MODE_FAILED                    = BASE + 76;

    /** @hide */
    public static final int DISCONNECT                              = BASE + 77;
   ...
   /**
    ...
    /** Stop a p2p conenction to a device with the specified device address.
     *
     * <p> The function call immediately returns after sending a deauth to the conencted device.
     * If the device tries again to connect, the device will be remembered as a persistent connection.
     * @param c is the channel created at {@link #initialize}
     * @param config options as described in {@link WifiP2pConfig} class
     * @param listener for callbacks on success or failure. Can be null.
     */
    public void disconnect(Channel c, WifiP2pConfig config, ActionListener listener) {
         checkChannel(c);
         checkP2pConfig(config);
         c.mAsyncChannel.sendMessage(DISCONNECT, 0, c.putListener(listener), config);
    }
    ...
    /** @hide */
    public void requestMiracastMode(Channel c, boolean mode, ActionListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(CMD_SET_MIRACAST_MODE, mode?1:0, c.putListener(listener));
    }
