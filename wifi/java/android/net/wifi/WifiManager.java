...
public class WifiManager {
    ...
    /**
     * In this Wi-Fi lock mode, Wi-Fi will operate in low latency mode.
     * Wi-Fi throughput might not be best. This will disable roaming.
     * This is useful for real time streaming applications.
     * @hide
     */
    public static final int WIFI_MODE_STA_LOW_LATENCY = 4;

    /**
     * In this Wi-Fi lock mode, AMPDU will be disabled for all TID.
     * @hide
     */
    public static final int WIFI_MODE_DISABLE_AMPDU = 5;
   ...
   /**
    ...
    /**
     * API to get maximum link speed of connected link
     * @hide
     */
    public int getMaxLinkSpeed() {
        try {
            return mService.getMaxLinkSpeed();
        } catch (RemoteException e) {
            return -1;
        }
    }
