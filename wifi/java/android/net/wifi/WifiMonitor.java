...
public class WifiMonitor {
    ...
    private static final int FREQ_CONF    = 10;
    ...
    private static final String FREQUENCY_CONFLICT_STR = "FREQ-CONFLICT";
   ...
   /* Network connection completed */
    ...
    /* Frequency Conflict Event */
    public static final int FREQUENCY_CONFLICT_EVENT             = BASE + 13;
    ...
    private static class MonitorThread extends Thread {
        ...
        private boolean dispatchEvent(String eventStr) {
            ...
            if (eventName.equals(CONNECTED_STR))
                ...
                event = ASSOC_REJECT;
            else if (eventName.equals(FREQUENCY_CONFLICT_STR))
                event = FREQ_CONF;
            else
                event = UNKNOWN;
        ...
        void handleEvent(int event, String remainder) {
            switch (event) {
                ...
                case FREQ_CONF:
                    mStateMachine.sendMessage(FREQUENCY_CONFLICT_EVENT);
