...
public static final int EGL_CORE_NATIVE_ENGINE             = 0x305B;
    ...
    // C function EGLBoolean eglPostSubBufferNV ( EGLDisplay dpy, EGLSurface surcface, int x, int y, int width, int height )
    /** @hide **/
    public static native boolean eglPostSubBufferNV(
        EGLDisplay dpy,
        EGLSurface surface,
        int x, int y,
        int width, int EGL_HEIGHT
    );
