...
public class DatabaseHelper extends SQLiteOpenHelper {
    static {
        System.loadLibrary("databasehelper_jni");
    }
    ...
    private boolean IsMaxBrightnessIn1stBoot() {
        return isMaxBrightnessIn1stBoot();
    }

    private native boolean isMaxBrightnessIn1stBoot();
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            if (IsMaxBrightnessIn1stBoot()) {
                loadIntegerSetting(stmt, Settings.System.SCREEN_BRIGHTNESS,
                    R.integer.max_screen_brightness);
            } else {
                loadIntegerSetting(stmt, Settings.System.SCREEN_BRIGHTNESS,
            ...
            loadSetting(stmt, Settings.System.PROMPT_TV_MODE, 1);

            loadStringSetting(stmt, Settings.System.STYLUS_LAUNCHER_DEFAULT_APPS,
                    R.string.def_stylus_launcher_default_apps);
        } finally {
            if (stmt != null) stmt.close();
        }
    }
